<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <!-- 🔥 Language Switch -->
                <div class="flex items-center space-x-3 me-6">
                    <a href="{{ route('lang.switch', 'en') }}" class="text-gray-500 dark:text-gray-300 hover:underline">🇬🇧 EN</a>
                    <a href="{{ route('lang.switch', 'es') }}" class="text-gray-500 dark:text-gray-300 hover:underline">🇪🇸 ES</a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="px-4 mt-2 flex space-x-4">
            <a href="{{ route('lang.switch', 'en') }}" class="text-gray-600 dark:text-gray-300 hover:underline">🇬🇧 EN</a>
            <a href="{{ route('lang.switch', 'es') }}" class="text-gray-600 dark:text-gray-300 hover:underline">🇪🇸 ES</a>
        </div>
